...
const discountedProductSchema = new mongoose.Schema(
    {
        ...
        lowPrice: { type: Number, required: true, min: [1, "el precio debe ser mayor de 1 siempre"]},
...
const DiscountedProduct = mongoose.model('DiscountedProduct', discountedProductSchema);
